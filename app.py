...
from hfrs_hybrid_pipeline.utils import load_cim10_mapping
...
LLM_MODEL_NAME = "mistral-small:latest"  # or another supported model

@st.cache_resource
def get_processor():
    # Load CIM10 mapping (use flat combined mapping for robust coverage)
    cim10_mapping = load_cim10_mapping("/home/coder/nalfe/data/cim10_mapping_flat.json")
    # You can pass additional config as needed
    return ClinicalNoteProcessor(cim10_mapping, ner_model_name=None, llm_model_name=LLM_MODEL_NAME)
